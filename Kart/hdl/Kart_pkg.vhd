...
-- Sensors
  ...
  constant DMOT_MINCMD_uS : positive := 400; -- MUST correspond to servomotor minimal pulse time to avoid it burning
  constant DMOT_MAXCMD_uS : positive := 2550; -- MUST correspond to servomotor maximal pulse time to avoid it burning
